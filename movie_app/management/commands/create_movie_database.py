...
class Command(BaseCommand):
    ...
    api_read_token = "eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI0NDUyOGEwZTdiZTk2MzBlMTUyOGUxYjZjNzlkNWI3MSIsIm5iZiI6MTczMjYyNTA5OS44NjQxMDA1LCJzdWIiOiI2NzQ1YzFhNWI3ZDU0YzNmNDc0ZmY1ZGYiLCJzY29wZXMiOlsiYXBpX3JlYWQiXSwidmVyc2lvbiI6MX0.G4Qz_yzO4r4Ya6sj3ldygC3SEmNIDCHjEXuLeukCX-E" # write your api read token here.

    api_key = "44528a0e7be9630e1528e1b6c79d5b71"
